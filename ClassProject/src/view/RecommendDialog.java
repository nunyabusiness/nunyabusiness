...
public class RecommendDialog extends JDialog {
	 ...
	 */
	public RecommendDialog(final Conference theConference, final Paper thePaper) {
		super();
	...
	private void initDialog() {
		...
		JLabel viewLabel = new JLabel("<html><u><i>Click To Read", SwingConstants.CENTER);
		...
		JLabel recLabel = new JLabel("<html><i>Please consider the reviews below when making your recommenation:", SwingConstants.CENTER);
		...
		submitButton.addActionListener(new ActionListener() {			
			public void actionPerformed(ActionEvent e) {
				...
				r.setState(nums[stateBox.getSelectedIndex()]);
